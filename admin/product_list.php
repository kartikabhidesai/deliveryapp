            ...
            <div id="wrapper">     
                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- End page heading -->
                        <span class="pull-right" ><a href="product_add.php" class="btn btn-icon btn-primary glyphicons" title="Add Product"><i class="icon-plus-sign"></i>Add Product</a></span>
                        <!-- Begin breadcrumb -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="viewModel">Product View</h3>
                    </div>
