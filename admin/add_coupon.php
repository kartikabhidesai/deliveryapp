<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
        ...
        {
			$error1 = "1";
			$errormessage1 = "Please select coupon start date";
		}
		elseif ($_POST["to_date"] == "")
        {
			$error1 = "1";
			$errormessage1 = "Please select coupon expiry date";
		}
		elseif ($_POST["from_date"] > $_POST["to_date"])
        {
			$error1 = "1";
			$errormessage1 = "Coupon expiry date must be more or equal to start date";
		}
		elseif ($start_time == "")
        {
			$error1 = "1";
			$errormessage1 = "Please select coupon start time";
		}
		elseif ($expiry_time == "")
        {
			$error1 = "1";
			$errormessage1 = "Please select coupon expiry time";
		}
						...
						<form  id="addUser" class="form-horizontal" enctype="multipart/form-data" name="addUser"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<input type="text" class="form-control datepicker" name="from_date" value="<?php echo (isset($from_date) ? $from_date : ""); ?>" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" />
									</div>
									<div class="col-lg-2">
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<input type="text" class="form-control datepicker" name="to_date" value="<?php echo (isset($to_date) ? $to_date : ""); ?>" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy"  />
									</div>
									<div class="col-lg-2">
