...
$dbfunction->SimpleSelectQuery("select * from tbl_product where id=" . $converter->decode($_GET['id']));
        ...
        <div id="wrapper">     
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <h1 class="page-heading">Product Edit <small></small></h1>
                        ...
                        <form  id="addCat" class="form-horizontal" enctype="multipart/form-data" name="addProduct"  action="<?php echo $pageurl; ?>" method="post">
                            <fieldset>
                                    ...
                                    <div class="col-lg-5">
                                        <select class='form-control' name="category" id="category">
                                            ...
                                            <?php while($row=mysqli_fetch_array($query)){ ?>
                                                <option value="<?php echo $row['id']; ?>"<?php echo $row['id'] == $objsel['cat_id'] ? 'selected':''; ?>><?php echo $row['name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="prod_name" id="prod_name" value="<?php echo $objsel['product_name']; ?>" placeholder="Enter Category Name" required />
                                    </div>
                                    <span class="errorstar">&nbsp;*</span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="address" id="address" value="<?php echo $objsel['address']; ?>" placeholder="Enter Category Name" required />
                                    </div>
                                    <span class="errorstar">&nbsp;*</span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo $objsel['mobile']; ?>" placeholder="Enter Category Name" required />
                                    </div>
                                    <span class="errorstar">&nbsp;*</span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="checkbox">
                                            <span style="margin-left:10px"><img src="../uploads/product/<?php echo $objsel['image'] ?>" width="100" height="100" /></span>
                                        </div>
                                    </div>
                                </div>	
