<?php
	...
	if($pagename == "package_list" || $pagename == "add_package"  || $pagename == "coupon_list" || $pagename == "add_coupon"  
	|| $pagename == "commission_list" || $pagename == "fee_setting" || $pagename == "general_settings" 
	)
    {
