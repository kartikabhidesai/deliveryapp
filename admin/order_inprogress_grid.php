...
$sql = "SELECT * ";
$sql.=" FROM tbl_orders WHERE order_status='On the way'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$captainId = $converter->encode($row["captain_id"]);
	...
	$nestedData[] = '<span style="margin-left:10px"><a class="ViewDialogCaptain" data-id="'.$captainId.'" href="#viewModelCaptain" data-toggle="modal">'.$row["captain_name"].'</a></span>';
