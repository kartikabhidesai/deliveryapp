...
<!--[if !IE]><!--><html><!-- <![endif]-->
            ...
            <div id="wrapper">     
                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- End page heading -->
                        <span class="pull-right" ><a href="variant_add.php" class="btn btn-icon btn-primary glyphicons" title="Add Variant"><i class="icon-plus-sign"></i>Add Variant</a></span>
                        <!-- Begin breadcrumb -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="viewModel">Variant</h3>
                    </div>
    ...
    <script>
        var gridUrl = "variant_grid.php";
        var viewUrl = "variant_view.php";
        var actionUrl = "variant_action.php";
