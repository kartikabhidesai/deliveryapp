        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Customer(s) <small></small></h1>
					
					<!-- <span class="pull-right" ><a href="add_cust.php" class="btn btn-icon btn-primary glyphicons" title="Add Customer">Add Customer</a></span> -->
					<!-- End page heading -->
