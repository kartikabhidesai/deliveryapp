<?php
	...
	$pagename   = "package_list";
	$pageurl    = "package_list.php";
?>
<!DOCTYPE html>
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "View Package(s) :: Admin :: ".SITE_NAME; ?></title>
    ...
    <body onLoad="document.getElementById('st').focus();">
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Recharge Package(s) <small></small></h1>
					
					<!--<span class="pull-right" ><a href="add_package.php" class="btn btn-icon btn-primary glyphicons" title="Add Package"><i class="icon-plus-sign"></i>Add Package</a></span>-->
					<!-- End page heading -->
					...
					<?php
							if (isset($_GET["suc"]) && $_GET["suc"] != "")
                            {
								...
								$success = $converter->decode($_GET["suc"]);
									if ($success == 1)
                                {
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Package", $lang["updatemessage-status"]).'"); </script>';
								}
								elseif ($success == 2)
                                {
									
									echo '<script> getMessage("error","'.str_replace("{modulename}", "Package", $lang["deletemodulemessage"]).'"); </script>';
								}
								elseif ($success == 3)
                                {
								...
								elseif ($success == 4)
                                {
									...
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Package", $lang["addmodulemessage"]).'"); </script>';
								}
								elseif ($success == 5)
                                {
									
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Package", $lang["updatemodulemessage"]).'"); </script>';
								}
								elseif ($success == 6)
                                {
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-header">
				...
				<h3 class="modal-title" id="viewModel">Package Info</h3>
			  </div>
		...
		<script>
		var gridUrl = "package_grid.php";
		var viewUrl = "package_view.php";
		var actionUrl = "package_action.php";
