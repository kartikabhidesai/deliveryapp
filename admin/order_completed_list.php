<?php
	...
	$pagename   = "order_completed_list";
	$pageurl    = "order_completed_list.php";
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "View Completed Order(s) :: Admin :: ".SITE_NAME; ?></title>
		<link rel="shortcut icon" type="image/x-con" href="images/favicon.ico" />
		<script>
		var gridUrl = "order_completed_grid.php";
    ...
    <body onLoad="document.getElementById('st').focus();">
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Completed Order(s) <small></small></h1>
		...
		<!-- Modal -->
		<div class="modal fade" id="viewModelCaptain" tabindex="-1" role="dialog" aria-labelledby="viewModelCaptain" aria-hidden="true">
		  <div class="modal-dialog">
			<div class="modal-content">
			
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title" >Captain Info</h3>
			  </div>
			  <div class="panel-body" id="txtHintCaptain"> 
		...
		<script>
			var targetsCols = [0,1,2,3,4,5,6,7,8];
			var orderCols = [[6,"desc"]];
			var buttonValue = ['excel', 'pdf'];	
			$(document).ready(function() {
			
				$(document).on("click", ".ViewDialogCaptain", function () {
					var id = $(this).data('id');
					 var xmlhttp = new XMLHttpRequest();
					xmlhttp.onreadystatechange = function() {
					if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
						document.getElementById("txtHintCaptain").innerHTML = xmlhttp.responseText;
					}
					};
					
					xmlhttp.open("GET", "captain_view.php?id=" + id, true);
					xmlhttp.send();
				});	
			});
		</script>
