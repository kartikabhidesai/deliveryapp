<?php
	...
	$pagename   = "captain_list";
	$pageurl    = "captain_list.php";
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head>
        ...
        <title><?php  echo "View Captain(s) :: Admin :: ".SITE_NAME; ?></title>
        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Captain(s) <small></small></h1>
					...
					<ol class="breadcrumb default square rsaquo sm">
						...
						<li><a href="captain_list.php">Captain</a></li>
