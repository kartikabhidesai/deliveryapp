<?php
	...
	$sql = $conn->get_record_set("SELECT * FROM `tbl_messages` WHERE $where (sender_id='$user_id' OR receiver_id='$user_id') AND order_id='$order_id' AND is_deleted='0' ORDER BY message_id");
