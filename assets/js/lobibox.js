...
//------------------------------------------------------------------------------
    ...
    Lobibox.alert = function (type, options) {
        if (["success", "error", "warning", "info","active","deactive","cancelled","loggedin"].indexOf(type) > -1) {
...
//------------------------------------------------------------------------------
    ...
    Lobibox.base.OPTIONS = {
        ...
        modalClasses: {
			...
			'active': 'lobibox-success',
			'deactive': 'lobibox-success',
			 'cancelled': 'lobibox-error',
			 'loggedin': 'lobibox-success'
        },
        ...
        icons: {
            bootstrap: {
				...
				active: 'glyphicon glyphicon-ok-sign',
				deactive: 'glyphicon glyphicon-ok-sign',
				cancelled: 'glyphicon glyphicon-remove-sign',
				loggedin: 'glyphicon glyphicon-ok-sign'
            },
            fontAwesome: {
				...
				active: 'fa fa-check-circle',
				deactive: 'fa fa-check-circle',
				cancelled: 'fa fa-times-circle',
				loggedin: 'fa fa-check-circle'
            }
        }
    };
...
//------------------------------------------------------------------------------
        ...
        var _createNotify = function () {
            ...
            $body = $('<div></div>', {
                'class': 'lobibox-notify-body left'
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify = function (type, options) {
        if (["default", "info", "warning", "error", "success","active","deactive","cancelled","loggedin"].indexOf(type) > -1) {
